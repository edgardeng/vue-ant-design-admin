export default {
  ...
  'user.login.username.placeholder': 'account: admin or test',
  'user.login.password.placeholder': 'password: 123456',
  ...
  'user.password.length.required': 'Please enter 6 - 18 character!',
