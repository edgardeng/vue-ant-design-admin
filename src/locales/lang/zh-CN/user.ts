export default {
    ...
    'user.login.username.placeholder': '账户: admin or test',
    'user.login.password.placeholder': '密码: 123456',
    ...
    'user.login.mobile.placeholder': '手机号:17012341234',
    'user.login.mobile.verification-code.placeholder': '验证码:1234',
    'user.login.remember-me': '自动登录',
    'user.login.forgot-password': '忘记密码',
    'user.login.sign-in-with': '其他登录方式',
    'user.login.signup': '注册账户',
    'user.login.login': '登录',
    'user.format.error': '格式错误',
    ...
    'user.password.length.required': '请输入密码6-18位密码',
